...
3. [检索增强生成（RAG）](./projects/NJU_2025spring_ragprojects.md)

4. [基于大语言模型的零样本文档排序](./projects/NJU_2025spring_ranking.md)

5. [多模态谣言检测](./projects/NJUProject_MultimodalRumorDetection.md)
