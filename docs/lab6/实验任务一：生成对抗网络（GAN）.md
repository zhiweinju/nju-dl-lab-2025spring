...
![WeChat1450a03e73cbf16ffd995f8226f07abe](images/WeChat1450a03e73cbf16ffd995f8226f07abe.jpg)

训练生成器的损失函数其实是对抗损失V(D,G)中关于噪声z的项，其损失函数为：

![WeChatc4f85499a2b666a9e06c1f20986ea310](images/WeChatc4f85499a2b666a9e06c1f20986ea310.jpg)

训练判别器的损失函数其实是对抗损失V(D,G)中关于样本x的项，其损失函数为：

![WeChate2fadcb06a00d21264f169bb97804184](images/WeChate2fadcb06a00d21264f169bb97804184.jpg)
...
class Discriminator(nn.Module):
    def __init__(self, input_dim, hidden_dim):
        ...
        self.model = nn.Sequential(
            ...
            #TODO   # 使用 LeakyReLU 激活函数，避免梯度消失问题
            #TODO   # 第一个隐藏层到第二个隐藏层，使用线性层
            #TODO   # 再次使用 LeakyReLU 激活函数
...
<!-- !!! Question "ReLU or LeakyReLU"

    ReLU和LeakyReLU各有什么特征？
    
    结合生成器与判别器的功能，思考一下，在生成器与判别器应该分别使用哪一个？可以分别测试一下，给出你的选择 -->
...
def main():
    ...
    for epoch in range(num_epoch):
        ...
        if not os.path.exists('./data/results_GAN'):
            os.makedirs('./data/results_GAN')
        save_image(fake_images, f'./data/results_GAN/{epoch}_epoch.png')  # 保存生成图像
```
...
![WeChat794ce1de314afd1859b7ad0459804b47](images/WeChat794ce1de314afd1859b7ad0459804b47.jpg)

这个损失函数的目标是：

<!-- *•***如果真实标签是 1（真实数据）**，希望也![WeChat5d7c6dae9d3d3bcc7359fdcdbeaf0c8a](images/WeChat5d7c6dae9d3d3bcc7359fdcdbeaf0c8a.jpg)接近 1，这样 ![WeChat8aaf016817ddab4f679d478a224f3558](images/WeChat8aaf016817ddab4f679d478a224f3558.jpg)的值较大，损失较小。

•**如果真实标签是 0（假数据）**，希望 ![WeChat5d7c6dae9d3d3bcc7359fdcdbeaf0c8a](images/WeChat5d7c6dae9d3d3bcc7359fdcdbeaf0c8a.jpg)也接近 0，这样 !
[WeChatecca363f45d7411d9460f4a5944fb6c2](images/WeChatecca363f45d7411d9460f4a5944fb6c2.jpg)的值较大，损失较小。 -->
